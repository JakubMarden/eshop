...
<table id="serverstatustraffic" class="data" cellspacing="1">
<thead>
<tr>
...
<table id="serverstatusconnections" class="data" cellspacing="1">
<thead>
<tr>
...
<table id="serverstatusqueriessummary" class="data" cellspacing="1">
<thead>
<tr>
...
?>
    <table id="serverstatusqueriesdetails<?php echo $current_table; ?>" class="data" cellspacing="1">
    <col class="namecol" />
...
?>
    <table class="data" id="serverstatussection<?php echo $section_name; ?>" cellspacing="1">
