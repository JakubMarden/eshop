...
?>
<div style="background-color: #303030; padding: 5px; padding-bottom: 4px; height: 20px;">
<span style="width: 17px; height: 17px; display: block; float: left; background-color: <?= $cfg['ServerColorLight'] ?>; border: 1px solid <?= $cfg['ServerColorDark'] ?>"></span>
<span style="height: 20px; display: block; font-family: arial; font-size: 20px; line-height: 20px; font-weight: bold; float: left; margin-left: 5px; color: white;"><?= $cfg['Server']['verbose'] ?></span>
...
echo '</div>';
echo '<div style="display: table; width: 100%; font-size: 1px"></div>';
echo '</div>';
