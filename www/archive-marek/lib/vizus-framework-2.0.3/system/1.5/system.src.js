...
if (vizus.browser == undefined)
	vizus.browser = {};

// detekce prohlížeče - NEPOUŽÍVAT, pokud existuje jakékoliv jiné řešení!
vizus.browser.isFirefox = /firefox/i.test(window.navigator.userAgent);
...
/**
* Jednoduchá náhrada za thickbox/fancybox.
*
* @function
* @param {HTMLAnchorElement} link Element tagu A, který obsahuje obrázek.
* @tested
*/
vizus.image.showbox = function(link)
{
	...
	link.onclick = function()
	{
		...
		overlay.className = 'system-showbox-overlay';
		overlay.onclick = close;

		document.body.appendChild(frame);
		frame.className = 'system-showbox';
		frame.src = link.href;
		
		document.body.appendChild(wait);
		wait.className = 'system-showbox-wait';
...
/**
* Najde odkazy podle zadaného selektoru a aplikuje na ně showbox.
*
* @function
* @param {String} [selector] Query selector pro funkci document.querySelectorAll, výchozí je "a.system-showbox"
* @tested
*/
vizus.image.showboxes = function(selector)
{
	selector = (new vizus.Argument(selector, 'selector')).type(['String', 'Undefined', 'Null']).value('a.system-showbox');
